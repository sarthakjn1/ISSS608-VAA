...
p <- ggplot(df.c_median, aes(x = `Property Type`, 
 ...
 scale_fill_manual(values = custom_palette) +
  labs(color = "Type of Area", title = "Sale Prices of Private Property types with Type of Area",
       subtitle = "Higher Sale Prices of Private Properties on Land as compared to Strata ") + 
...
-   In general, the sale prices of properties on Land are higher than those on Strata for the same property type.
