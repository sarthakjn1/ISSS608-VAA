...
```{r}
pacman::p_load(ggrepel, patchwork, ggthemes, ggridges, hrbrthemes, colorspace,ggdist, tidyr, tidyverse)
```
...
```{r}
ggplot(realis_data,
       aes(x = Quarter,y = count, fill =`Type of Sale`)) +
  geom_bar() +
  theme_minimal() +
